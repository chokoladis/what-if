...
3) Запуск сидов последовательно - `php artisan db:seed DatabaseSeeder` (Затем QuestionSeeder, TagSeeder, QuestionTagSeeder, UserTagsSeeder)
4) контейнере запуск комманды - `php artisan reverb:start` (Временное решение)
### Другой вариант установки
1-2) аналогично
3) `Make db-restore` (Есть вероятность не актуальной структуры)
## Техническая часть
